      ...
      <CardContent className="pt-0">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div className="flex items-start gap-3 rounded-lg bg-card p-4 border border-border/40">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-[10px] text-muted-foreground">
                ({totalMinutesSaved.toLocaleString()}分)
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-lg bg-card p-4 border border-border/40">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-xl font-bold text-foreground">
                  {(costSavings / 10000).toFixed(1)}
                </span>
                <span className="text-xs text-muted-foreground">万円</span>
              </div>
              <span className="text-[10px] text-muted-foreground">
                ({costSavings.toLocaleString()}円)
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-lg bg-card p-4 border border-border/40">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <div className="flex flex-col gap-0.5 text-[10px] text-muted-foreground">
                <span>AI解決件数: {resolvedCount.toLocaleString()}件</span>
        ...
        <div className="mt-4 rounded-md bg-muted/50 p-3">
          <p className="text-xs text-muted-foreground font-mono">
            {resolvedCount.toLocaleString()}件 x {avgCallDurationMinutes}分 = {totalMinutesSaved.toLocaleString()}分
            {" → "}
            {totalMinutesSaved.toLocaleString()}分 x {costPerMinute}円 = {costSavings.toLocaleString()}円
          </p>
        </div>
      </CardContent>
    </Card>
